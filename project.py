...
class MusicPlayer:
    def __init__(self, root): 
        self.root = root
        self.root.title("Music Streaming platform for Python project")
        self.root.geometry("900x600")
        self.root.config(bg='black')

        # Load background image
        self.bg_image = Image.open(r"C:\Users\abhij\Downloads\WhatsApp Image 2024-10-15 at 18.34.24.jpeg") 
